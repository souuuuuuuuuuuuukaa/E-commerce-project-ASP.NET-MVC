...
namespace lunettes.Controllers
{
    public class OrderDetailsController : Controller
    {
        ...
        public OrderDetailsController(lunettesContext context)
        {
            _context = context;
        }
        ...
        {
            var lunettesContext = _context.OrderDetails.Include(o => o.Order).Include(o => o.Product);
        ...
        public async Task<IActionResult> Create([Bind("Id,OrderId,ProductId")] OrderDetails orderDetails)
        {
            ...
            ViewData["OrderId"] = new SelectList(_context.Order, "Id", "Address", orderDetails.OrderId);
            ViewData["ProductId"] = new SelectList(_context.Set<Products>(), "Id", "Name", orderDetails.ProductId);
            return View(orderDetails);
        }
